...
public class ContatoView extends JFrame {
    ...
    public ContatoView() {
        ...
        btnDeletar.setBounds(300, 60, 120, 25);
        add(btnDeletar);
    ...
    /**
     * Retorna o campo texto para o nome
     ...
     * @return Botão para listar todos os contato
     */
    ...
    /**
     * Retorna o modelo da tabela que contem os contatos
